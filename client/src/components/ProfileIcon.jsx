...
//               src={user.avatar}
//               alt="User Avatar"
//               className={`rounded-full w-10 h-10 ${isCollapsed ? "w-10 h-10": "w-10 h-10"}`}
//             />
//           </span>
//         ) : (
  ...
  return (
    <div className="relative flex items-center" ref={dropdownRef}>
      ...
      >
        {user?.avatar ? (
          <span
            className={` ${isCollapsed ? "w-12/12 border-2 border-white rounded-full shadow-sm " : "w-6/12 ml-1"}`}
          >
            <img
              src={user.avatar}
              alt="User Avatar"
